...
export function AiChatbot() {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiResponses = [
        "That's a great question! Khushboo specializes in Deep Learning and NLP.",
        "Based on her portfolio, she has extensive experience with Python, TensorFlow, and React.",
        "She is currently open to new opportunities in Machine Learning Engineering.",
        "You can check out her GitHub for more detailed code examples!",
      ]
